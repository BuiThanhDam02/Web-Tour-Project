...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="table-data-table.html"><i class='app-menu__icon bx bx-id-card'></i> <span
...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Thêm hướng dẫn viên</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                ...
                <h3 class="tile-title">Tạo mới hướng dẫn viên</h3>
                <div class="tile-body">
                ...
                <a class="btn btn-cancel" href="table-data-table.html">Hủy bỏ</a>
            </div>
