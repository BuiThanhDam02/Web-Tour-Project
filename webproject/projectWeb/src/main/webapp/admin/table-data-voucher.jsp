...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="table-data-voucher.html"><i class='app-menu__icon bx bx-run'></i><span
                ...
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="form-add-voucher.html" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới Voucher</a>
                        </div>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            ...
                            <td>19/11/2022</td>
                            <td>23/11/2022</td>
                            <td><span class="badge bg-warning">Còn khả dụng</span></td>
                        ...
                        <tr>
                            ...
                            <td>19/11/2022</td>
                            <td>23/11/2022</td>
                            <td><span class="badge bg-danger">hết khả dụng</span></td>
                            <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i></button>
