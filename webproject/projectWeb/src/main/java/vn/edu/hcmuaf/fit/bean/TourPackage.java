...
public class TourPackage implements Serializable {
    ...
    public TourPackage(TourDetail tourDetail,Destination destination, List<TourDetailDays> dayList, List<TourDetailImages> imageList, List<TourDetailType> typeList, List<Review> reviewList, List<TourGuide> guideList) {
